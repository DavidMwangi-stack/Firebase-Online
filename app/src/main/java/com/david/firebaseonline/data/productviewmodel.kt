package com.david.firebaseonline.data
...
import com.david.firebaseonline.model.Product
import com.david.firebaseonline.model.Upload
import com.david.firebaseonline.navigation.ROUTE_LOGIN
...
class productviewmodel(var navController: NavHostController, var context: Context) {
  ...
  //  var progress: ProgressDialog
    ...
    fun viewProducts(
        ...
        var ref = FirebaseDatabase.getInstance().getReference().child("Product")
    ...
    fun saveProductWithImage(productName:String, productQuantity:String, productPrice:String, filePath: Uri){
        var id = System.currentTimeMillis().toString()
        var storageReference = FirebaseStorage.getInstance().getReference().child("Upload/$id")
    //    progress.show()
    ...
    fun viewUploads(upload:MutableState<Upload>, uploads:SnapshotStateList<Upload>): SnapshotStateList<Upload> {
        var ref = FirebaseDatabase.getInstance().getReference().child("Upload")
